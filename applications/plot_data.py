...
from tgblib import spectrum_fit
...
if __name__ == '__main__':
    ...
    for iper in range(2):
        ...
        sf = spectrumFit.SpectrumFit(energy=nuStarEnergy, spec=nuStarFlux, specErr=nuStarFluxErr)
        ...
        if show:
            ...
            plt.savefig('figures/DataNuStar_' + str(iper) + '_' + label + '.png',
                        format='png',
                        bbox_inches='tight')
            plt.savefig('figures/DataNuStar_' + str(iper) + '_' + label + '.pdf',
                        format='pdf',
                        bbox_inches='tight')
        ...
        sf = spectrumFit.SpectrumFit(energy=vtsEnergy, spec=vtsFlux, specErr=vtsFluxErr)
        ...
        if show:
            ...
            plt.savefig('figures/DataVTS_' + str(iper) + '_' + label + '.png',
                        format='png',
                        bbox_inches='tight')
            plt.savefig('figures/DataVTS_' + str(iper) + '_' + label + '.pdf',
                        format='pdf',
                        bbox_inches='tight')
